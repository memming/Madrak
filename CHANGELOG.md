...
### Fixed
- Fixed song detection for YouTube Music radio - track changes are now detected even when page title doesn't update between songs
- Added fallback mechanism that checks player bar HTML content changes in addition to title changes
