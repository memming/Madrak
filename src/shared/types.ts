...
export interface Message {
  type: 'TRACK_DETECTED' | 'TRACK_ENDED' | 'SCROBBLE_SUCCESS' | 'SCROBBLE_ERROR' | 'AUTH_SUCCESS' | 'AUTH_ERROR' | 'SETTINGS_UPDATE' | 'GET_QUEUE_STATS' | 'START_AUTH' | 'COMPLETE_AUTH' | 'LOGOUT' | 'CLEAR_ALL_DATA' | 'GET_DEBUG_INFO' | 'EXPORT_LOGS' | 'PING' | 'GET_CURRENT_TRACK' | 'REFRESH_USER_DATA' | 'TRACK_CHANGED';
  data?: any;
  error?: string;
}
